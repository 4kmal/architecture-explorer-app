(function () {
  ...
  const SOURCE_FILES = {
    ...
    'user-explore-3d-map-flowchart': { url: 'assets/editor/flowchart-user-explore-3d-map.drawio?v=20260715-1', pageId: 'petakerja_flow_user_explore_3d_map', filename: 'Flow Chart PetaKerja - Explore the 3D Map - Polished.drawio' },
