...
- Supported sequences show a global `Simple | Code` / `Ringkas | Kod` control in View mode. Simple is the persisted default; Code exposes exact selectors, function names, routes and queries without changing the shared Draw.io geometry or dirty state.
